...

                        {
                            categories.map((cat, index) => (
                                <SwiperSlide key={index}>
                                    <div className={`lg:h-[27rem] md:h-[27rem] h-[25rem] flex ${active === index ? 'skew-x-0 scale-[100%]' : 'skew-x-3 scale-[80%]'} transform relative ${active === index ? 'hover:scale-[102%]':"hover:scale-[85%]"} delay-100 transition-all  ease-in-out cursor-grab`}>
