...
const About = () => {
    return (
        <div className='relative bg-no-repeat min-h-fit bg-center bg-cover py-32 bg-[url("https://ragam.co.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Felephant.675d7836.jpeg&w=1080&q=75")]'>
            ...
            <div data-aos="fade-up" className='bg-black bg-opacity-50 backdrop-blur-sm rounded-[2rem] lg:w-[70%] md:w-[80%] w-[90%] m-auto z-[1999999] lg:p-10 md:p-10 p-7 lg:py-20 md:py-20 py-10 border border-gray-500'>
