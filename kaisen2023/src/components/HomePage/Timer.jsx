...
const Timer = () => {
    ...
    return (
        <div className="bg-[url('/images/ship1.png')] bg-repeat-y  min-h-fit bg-center bg-cover flex relative justify-center items-center">
            <div data-aos="zoom-in-up" className="flex bg-gray-800 bg-opacity-30 backdrop-blur-md m-auto gap-12 rounded-3xl lg:p-14 md:p-10 p-5 lg:my-32 md:my-26 my-24">
