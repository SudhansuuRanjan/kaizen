    ...
    return (
        <div className='flex flex-col items-center justify-center gap-20 bg-opacity-20 backdrop-blur-0 rounded-[2rem] lg:w-[70%] w-[90%] m-auto mb-24 z-[1999999]'>
            ...
            <p className='text-lg font-medium text-center'>
                KAIZEN 2023 Event Schedules are relased.<br/>Check out the schedule noww.
            </p>
            <div>
                <Link to="/schedule"><button className='px-5 py-2.5 animate-bounce bg-pink-600 text-white text-lg font-medium hover:scale-105 transition-all delay-75 rounded-xl ease-in hover:bg-pink-700'>
                    KAIZEN Schedule
                </button></Link>
            </div>
        </div>
