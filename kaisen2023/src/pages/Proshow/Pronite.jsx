    ...
    <div className='pronite-container'>
      ...
      <div className='pronite-cards'>
        ...
        <div className="pronite-card-container">
          <div className=''>
            <img alt="MOHAN SISTERS" src="https://ragam.co.in/images/Jubin%20proshow.png" height={560} width={560} decoding="async" data-nimg="1" class="ProshowPage_img__TkM26" loading="lazy" className='w-[560px] h-[100%] aspect-square' />
          </div>
